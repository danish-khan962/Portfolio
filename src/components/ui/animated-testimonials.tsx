...
export const AnimatedTestimonials = ({
  ...
  useEffect(() => {
    ...
    setRotateYValues(randomRotations);
  }, [testimonials]);
  ...
  // Prevent rendering until mounted and rotations are ready
  if (!isMounted || rotateYValues.length === 0) {
    return null;
  }
              ...
              {testimonials.map((testimonial, index) => (
                <motion.div
                  ...
                  animate={{
                    ...
                    rotate: isActive(index) ? 0 : rotateYValues[index],
