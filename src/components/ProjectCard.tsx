...
const ProjectCard = () => {
  return (
    <div className={`max-w-[700px] w-[100%] my-[40px] md:my-[80px] ${ubuntu.className} group`}>
      <div>
        <Link href={`/project`}>
          <Image src={background_image_2} alt={"bg"} height={1000} width={1000} className='h-[350px] w-full bg-center rounded-lg' loading={"lazy"}/>
        </Link>
      </div>
      <div className='flex flex-row justify-between items-center'>
        <div className='flex flex-col'>
          <p className='font-semibold text-sm mt-4 text-gray-300/75 group-hover:translate-x-7 transition-all ease-in-out duration-300'> June 17, 2025 </p>
