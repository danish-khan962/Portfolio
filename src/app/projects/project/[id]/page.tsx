        ...
        <div className='max-w-[700px] w-[100%] flex flex-row justify-between items-center gap-x-3'>
          ...
          <div className='w-[50%]'>
            <Link href={project.live_link} target='_blank'>
              <button className='bg-blue-400/10 py-2 px-8 rounded-lg w-[100%] backdrop-blur-md border-2 border-white/10 hover:border-white/15 transition-all ease-in-out duration-200 cursor-pointer'> Watch Live </button>
            </Link>
          </div>
        </div>
      </div>
